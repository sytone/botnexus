...
**Purpose**: Automatically generated reference of all configured agents, their models, roles, and providers. Also includes minimal memory guidance.
...
- Includes a `## Memory Notes` section with guidance on using `MEMORY.md` for durable facts and `memory/YYYY-MM-DD.md` for daily work context
