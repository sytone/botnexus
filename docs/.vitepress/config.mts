  ...
  themeConfig: {
    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            collapsed: true,
            items: [
              { text: "Choose and connect a provider", link: "/user-guide/providers" },
          ...
          {
            text: "Add and use extensions",
            collapsed: true,
            items: [
              { text: "Use extensions", link: "/user-guide/using-extensions" },
          ...
          },
          {
            ...
            collapsed: true,
            items: [
              { text: "Choose a feature", link: "/user-guide/capabilities" },
          ...
          {
            text: "Ideas and task guides",
            collapsed: true,
            items: [
              { text: "Things to try", link: "/user-guide/usage-ideas" },
              { text: "Audio Recording", link: "/guides/audio-recording" },
              { text: "Webhooks", link: "/guides/webhooks" },
            ],
          },
          {
            text: "Settings and commands",
            collapsed: true,
            items: [
      ...
      },
      {
        ...
        items: [
          {
            text: "Start and contribute",
            collapsed: true,
            items: [
              { text: "Developer Setup", link: "/getting-started-dev" },
              { text: "Guide overview", link: "/development/README" },
              { text: "Documentation standards", link: "/development/documentation-standards" },
              { text: "Portal design system", link: "/design-system" },
              { text: "Static factory naming", link: "/development/static-factory-naming" },
              { text: "GitHub write-tool contracts", link: "/development/github-write-tool-contracts" },
              { text: "Web-fetch destination policy", link: "/development/web-fetch-destination-policy" },
              { text: "Agent conversation deadlines", link: "/features/agent-converse-deadline-provenance" },
          ...
          {
            text: "Build extensions and integrations",
            collapsed: true,
            items: [
              ...
              { text: "Custom tool and skill authoring reference", link: "/user-guide/extensions" },
            ],
          },
          {
            text: "API reference",
          ...
          },
          {
            ...
            collapsed: true,
            items: [
              { text: "Newline and empty-text tests", link: "/development/newline-delta-conformance" },
              { text: "PowerShell test isolation", link: "/development/powershell-test-isolation" },
          ...
          },
          {
            ...
            items: [
              ...
              { text: "Maintenance PR file coverage", link: "/development/maintenance-pr-footprints" },
              { text: "Maintenance PR freshness", link: "/development/maintenance-pr-freshness" },
            ],
          },
          {
            text: "Research and proposals",
            collapsed: true,
            items: [
