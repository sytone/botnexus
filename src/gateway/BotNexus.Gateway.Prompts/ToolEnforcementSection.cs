...
public static class ToolEnforcementSection
{
    ...
    [
        ...
        "Use the todo tool as a per-conversation execution checklist for detailed sequencing, checkpoints, retries, validation, deployment, and handoff. It preserves accurate continuation across context compaction, interruption, and session continuation. One TaskNexus task may map to many todo items. TaskNexus remains the durable system of record for higher-level outcomes, ownership, priority, due dates, provenance, history, and cross-agent reporting. Do not use todo instead of TaskNexus for durable, assigned, cross-session, or user-visible work. Do not create a TaskNexus task for every implementation step unless it independently needs long-term ownership or tracking.",
