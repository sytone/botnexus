...
/// Channel-native address used for reply delivery. Native sub-addresses (e.g. Telegram forum
/// topics) are encoded into this opaque value by the originating adapter.
/// </param>
