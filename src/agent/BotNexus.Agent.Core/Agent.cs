...
public sealed class Agent
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        catch (OperationCanceledException) when (linkedCts.IsCancellationRequested)
        {
            var abortedMessage = new AssistantAgentMessage(
                ...
                FinishReason: BotNexus.Agent.Providers.Core.Models.StopReason.Aborted,
        ...
        catch (Exception ex)
        {
            var failureMessage = new AssistantAgentMessage(
                Content: string.Empty,
                FinishReason: BotNexus.Agent.Providers.Core.Models.StopReason.Error,
    ...
    private AgentLoopConfig BuildLoopConfig()
    {
        ...
        BotNexus.Agent.Providers.Core.Models.ThinkingLevel? thinkingLevel;
