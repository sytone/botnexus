...
public sealed record CrossWorldRelayRequest
{
    ...
    /// <summary>
    /// Optional per-turn idempotency key generated by the sender. When supplied, the
    /// receiver skips re-appending the user turn if the last history entry already
    /// carries the same key — preventing duplicate user-turn entries on cancel-and-retry.
    /// Null for single-turn or legacy senders that do not set this field.
    /// </summary>
