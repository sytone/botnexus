...
/// <summary>
/// Probe round 3 - Surfaces 1, 2, 3, 6 Blazor component and service tests.
/// (Surface 4 config-panel tests were retired when the hand-written config panels were replaced by
/// the schema-driven SchemaForm; see ConfigurationPageSchemaFormTests and SchemaFormTests.)
/// </summary>
public sealed class ProbeRound3BlazorTests : IDisposable
{
    ...
    public void GatewayEventHandler_HandleSubAgentCompleted_UpdatesStatusAndAddsMessage()
    {
        ...
        agent.Conversations["conv-1"].Messages
            .ShouldContain(m => m.Content.Contains("Worker"));
    }
}
